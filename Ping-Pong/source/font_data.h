/* 8x8 bitmap font tablolari
 * Kaynak: dhepper/font8x8 (Public Domain, Marcel Sondaar / IBM VGA fontlari)
 * Her byte bir satir; en dusuk bit (0x01) en soldaki piksel.
 * Bu dosya uretilmistir - elle duzenlemeyin. Turkce ek glifler font.c icinde.
 */
#ifndef FONT_DATA_H
#define FONT_DATA_H
